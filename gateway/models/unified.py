...
class DiagnosisResult(BaseModel):
    ...
    def from_bucket_output(
        ...
        bucket_desc_map = {
            "knee": {
                "OA": "무릎 연골이 약해지고 아침에 뻣뻣하며 점진적으로 통증이 나타나는 패턴입니다. 계단 보행이나 장시간 보행에서 증상이 두드러집니다.",
                "OVR": "반복 사용/운동량 증가 후 앞무릎 통증이 심해지는 패턴입니다. 휴식 시 호전되는 경향이 동반됩니다.",
                "TRM": "넘어짐·비틀림 등 외상 이후 급성 통증과 붓기가 동반되는 패턴입니다. 특정 동작에서 통증이 급격히 악화될 수 있습니다.",
                "INF": "염증·붓기·열감이 있고 아침 강직이 두드러지는 패턴입니다. 전신 피로감이나 염증 반응이 동반될 수 있습니다.",
            },
            "shoulder": {
                "OA": "어깨 관절 퇴행으로 뻣뻣함과 통증이 서서히 심해지는 패턴입니다. 팔을 크게 쓰는 동작에서 불편이 커집니다.",
                "OVR": "팔을 올리거나 반복 사용 후 통증이 악화되는 과사용 패턴입니다. 휴식 시 완화되는 경향이 있습니다.",
                "TRM": "외상 이후 힘 빠짐 또는 급성 통증이 동반되는 패턴입니다. 특정 방향 움직임에서 통증이 뚜렷할 수 있습니다.",
                "STF": "야간통과 가동범위 제한이 특징인 경직/동결견 패턴입니다. 어깨 회전 범위가 감소하는 경우가 많습니다.",
            },
        }
